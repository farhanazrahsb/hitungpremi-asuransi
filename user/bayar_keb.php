...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM polis_keb WHERE no=".$_GET['no'];
...
$status_bayar              = $_POST['status_bayar'];
 ...
 $sql_query = "UPDATE polis_keb SET id_order='$id_order', tanggal='$tanggal', nama='$nama', nama_bank='$nama_bank', nama_rek='$nama_rek', no_rek='$no_rek', total_tf='$total_tf', status_bayar='$status_bayar' WHERE no=".$_GET['no'];
 // sql query for update data into database
...
<!-- banner -->
<div class="banner">
	<h2>Detail Bayar Premi Kebakaran</h2>
	<p><a href="beranda.php">Home »</a> Detail Bayar Premi Kebakaran </p>
</div>
<!--//banner -->
...
<section class="contact" id="contact">
	<div class="container">
		<div class="contact-heading">
			<h3 class="heading">Detail Bayar Premi Kebakaran</h3>
		</div>
		<div class="contact-heading">
		...
		<div class="contact-grids">
			<div class="col-md-6">
				...
				<?php
                    ...
                    $no=$_GET['no'];
                    $query = mysql_query ("SELECT * FROM polis_keb WHERE no='$no'");
                    while ($var=mysql_fetch_array($query)) {
