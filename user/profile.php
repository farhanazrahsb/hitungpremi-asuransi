...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE user SET nama='$nama', username='$username', password='$password', email='$email' WHERE id_user='$id_user'";
 // sql query for update data into database
				...
				<div class="w3ls-social-icons text-left">
					...
					<a class="login" href="#" data-toggle="dropdown" style="height: 35px; padding-top: 7px;"><?php echo $_SESSION['username'] ?><span class="caret"></span></a>
				      <ul class="dropdown-menu">
				        <li class="active"><a href="profile.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
...
<div class="banner">
	<h2>Profile</h2>
	<p><a href="beranda.php">Home »</a> Profile </p>
</div>
<!--//banner -->
...
<section class="contact" id="contact">
	<div class="container">
		...
		<div class="contact-grids">
			...
			<div class="col-md-6">
			<h4 style="color: red;">Lengkapi Data Diri : * <a href="datadiri.php"><button type="submit" class="btn btn-info">Click Here</button></a></h4>
			</div>
		</div>
		<?php }; ?> 
	</div>
