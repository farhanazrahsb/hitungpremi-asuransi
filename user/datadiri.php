...
<div class="banner">
	<h2>Data Diri</h2>
	<p><a href="beranda.php">Home »</a> Data Diri </p>
</div>
<!--//banner -->
...
<section class="contact" id="contact">
	...
	<a class="btn btn-info" onclick="self.history.back()"> <span class="fa fa-arrow-left" title="Kembali"></span> Back</a>
		...
		<div class="contact-grids">
            ...
            <thead>
            <tr>
            	<th colspan="11"><a href="isidatadiri.php"><button type="submit" class="btn btn-info">Isi Data Diri</button></a></th>
            </tr>
            <tr>
            	<th>ID User</th>
                <th>Nama</th>
            ...
            $query = mysql_query ("SELECT * FROM datalengkap_user WHERE username='".$username."'");
            ...
            <tr>
                ...
                <td align="center"><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_datadiri.php?no=$var[no]'></a>"; ?></td>
            </tr>
            <?php
            }
            ?>
