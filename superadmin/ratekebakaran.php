                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="6"><a href="tambah_rate_keb.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Rate</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Rate</th>
                                    ...
                                    <?php
                                      ...
                                      $query = mysql_query ("SELECT * FROM rate_kebakaran");
                                      $no=1;
                                      while ($var=mysql_fetch_array($query)) {
                                    ...
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_ratekebakaran.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_ratekebakaran.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
