                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="6"><a href="tambah_kategori.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Kategori</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Kategori</th>
                                    ...
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_kategori.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_kategori.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
