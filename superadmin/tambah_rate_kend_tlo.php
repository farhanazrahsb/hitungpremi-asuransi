                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        include '../koneksi/koneksi.php';
                                        // membuat query max
                                          $carikode = mysql_query("select max(id_rate) from rate_kendaraan_tlo") or die (mysql_error());
                                          // menjadikannya array
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO rate_kendaraan_tlo (id_rate, id_kategori, id_wilayah, rate) VALUES ('$_POST[id_rate]', '$_POST[id_kategori]', '$_POST[id_wilayah]', '$_POST[rate]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_rate_kend_tlo.php'>";
                                    }else{
