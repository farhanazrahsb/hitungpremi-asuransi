        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <li>
                    <a class="active-menu" href="wilayah.php">Wilayah</a>
                    </li>
                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        include '../koneksi/koneksi.php';
                                        // membuat query max
                                          $carikode = mysql_query("select max(id_wilayah) from data_wilayah") or die (mysql_error());
                                          // menjadikannya array
                                          ...
                                          if ($datakode) {
                                           ...
                                           $kode = $kode + 1;
                                           $kode_otomatis = "W".str_pad($kode, 2, "0", STR_PAD_LEFT);
                                          } else {
                                           $kode_otomatis = "W01";
                                          }

                                        echo'
                                        <input name="id_wilayah" class="form-control" placeholder="ID Wilayah" value="'.$kode_otomatis.'" readonly />
                                        ';?>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO data_wilayah (id_wilayah, id_kategori, wilayah) VALUES ('$_POST[id_wilayah]', '$_POST[id_kategori]', '$_POST[wilayah]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_wilayah.php'>";
                                    }else{
