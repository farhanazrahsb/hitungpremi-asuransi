                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="6"><a href="tambah_rate_kend_tlo.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Rate</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Rate</th>
                                    ...
                                    <?php
                                      ...
                                      $query = mysql_query ("SELECT * FROM rate_kendaraan_tlo ORDER BY id_kategori asc");
                                      $no=1;
                                      while ($var=mysql_fetch_array($query)) {
                                    ...
                                    <td><?php echo $var ['rate']; ?></td>
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_kendaraan_tlo.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_kendaraan_tlo.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
