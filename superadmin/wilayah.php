                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="6"><a href="tambah_wilayah.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Wilayah</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Wilayah</th>
                                    ...
                                    <tr>
                                    <td><?php echo $no ?></td>
                                    <td><?php echo $var ['id_wilayah']; ?></td>
                                    <td><?php echo $kategori ['kategori']; ?></td>
                                    <td><?php echo $var ['wilayah']; ?></td>
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_wilayah.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_wilayah.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
