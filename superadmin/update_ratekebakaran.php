...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM rate_kebakaran WHERE no=".$_GET['no'];
...
$rate             = $_POST['rate'];
 ...
 $sql_query = "UPDATE rate_kebakaran SET id_rate='$id_rate', id_okupasi='$id_okupasi', id_kelas='$id_kelas', rate='$rate' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='ratekebakaran.php';
  </script>
  <?php
 }
 else
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <li>
                    <a class="active-menu" href="ratekebakaran.php">Rate</a>
                    </li>
                    </ul>
                </li>
                <li>
                                ...
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <select name="id_kelas" class="form-control">
                                            ...
                                            $query=mysql_query("select * from kelas_konstruksi order by id_okupasi asc");
                                            
                                            while($row=mysql_fetch_array($query))
                                            {
                                                $okupasi=mysql_fetch_array(mysql_query("SELECT keterangan FROM okupasi WHERE id_okupasi='$row[id_okupasi]'"));
                                            ?>
                                            <option value="<?php echo $row['id_kelas']; ?>"><?php echo $row['kelas']; ?> - <?php echo $okupasi['keterangan']; ?></option>
                                            <?php 
                                            }
                                            ?>
                                        </select>
