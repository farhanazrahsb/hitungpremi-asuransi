...
{
 $no = $_GET['no'];
 $sql_query=mysql_query('SELECT * FROM superadmin WHERE no="'.$no.'"');
...
$password       = $_POST['password'];
 ...
 $sql_query = "UPDATE superadmin SET nip='$nip', nama='$nama', no_hp='$no_hp', email='$email', username='$username', password='$password' WHERE nip='$nip'";
 // sql query for update data into database
