    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Data Rate Kendaraan All Risk</h2>   
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Rate Kendaraan All Risk Tables
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="6"><a href="tambah_rate_kend.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Rate</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Rate</th>
                                    ...
                                    <?php
                                      ...
                                      $query = mysql_query ("SELECT * FROM rate_kendaraan ORDER BY id_kategori asc");
                                      $no=1;
                                      while ($var=mysql_fetch_array($query)) {
                                    ...
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_kendaraan.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_kendaraan.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
