                            ...
                            <div class="row">
                                ...
                                echo'
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <input name="id_kategori" class="form-control" placeholder="ID Kategori" value="'.$kode_otomatis.'" readonly />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="text" name="tanggungan_awal" class="form-control" placeholder="Tanggungan Awal" />
                                        </div>
                                        <div class="form-group">
                                        <label>Batas Tanggungan</label>
                                        <input type="text" name="batas_tanggungan" class="form-control" placeholder="Batas Tanggungan" />
                                        </div>
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO kategori (id_kategori, kategori, tanggungan_awal, batas_tanggungan) VALUES ('$_POST[id_kategori]', '$_POST[kategori]', '$_POST[tanggungan_awal]', '$_POST[batas_tanggungan]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_kategori.php'>";
                                    }else{
