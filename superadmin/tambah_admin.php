    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    <a href="#" class="active-menu"><i class="fa fa-users"></i> Admin<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                    <li>
                    <a href="tambah_admin.php" class="active-menu">Tambah Admin</a>
                    </li>
                    <li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    $query = mysql_query("INSERT INTO admin (nip, nama, no_hp, email, username, password, gambar) VALUES ('$_POST[nip]', '$_POST[nama]', '$_POST[no_hp]', '$_POST[email]', '$_POST[username]', '$_POST[password]', '$nama')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_admin.php'>";
                                    }else{
