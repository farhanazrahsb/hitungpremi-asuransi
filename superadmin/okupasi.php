                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="5"><a href="tambah_okupasi.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Okupasi</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Okupasi</th>
                                    ...
                                    <?php
                                      ...
                                      $query = mysql_query ("SELECT * FROM okupasi");
                                      $no=1;
                                      while ($var=mysql_fetch_array($query)) {
                                    ?>
                                    <tr>
                                    <td><?php echo $no ?></td>
                                    <td><?php echo $var ['id_okupasi']; ?></td>
                                    <td><?php echo $var ['kode_okupasi']; ?></td>
                                    <td><?php echo $var ['keterangan']; ?></td>
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_okupasi.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_okupasi.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
