...
$pdf->Cell(47 ,5,'',0,0);
$pdf->Cell(100,10,'IKHTISAR POLIS ASURANSI KENDARAAN BERMOTOR',0,1);
...
$pdf->SetFont('Arial','','10');
$pdf->Cell(60,10,'Jenis kendaraan yang dipertanggungkan :',0,1,'L');

$pdf->Cell(53,5,'Merk Kendaraan',1,0,'C');
$pdf->Cell(40,5,'Tipe Kendaraan',1,0,'C');
$pdf->Cell(30,5,'Tahun Pembuatan',1,0,'C');
$pdf->Cell(27,5,'No Polisi',1,0,'C');
$pdf->Cell(40,5,'No Mesin',1,1,'C');

$pdf->Cell(53,5,$var['merk_kend'],1,0,'C');
$pdf->Cell(40,5,$var['tipe_kend'],1,0,'C');
$pdf->Cell(30,5,$var['tahun_kend'],1,0,'C');
$pdf->Cell(27,5,$var['no_polisi'],1,0,'C');
$pdf->Cell(40,5,$var['no_mesin'],1,1,'C');
...
$pdf->Cell(53,5,'No Rangka',1,0,'C');
$pdf->Cell(70,5,'Penggunaan Kendaraan',1,0,'C');
$pdf->Cell(40,5,'Harga Pertanggungan',1,0,'C');
$pdf->Cell(27,5,'Kondisi',1,1,'C');

$pdf->Cell(53,5,$var['no_rangka'],1,0,'C');
$pdf->Cell(70,5,$var['penggunaan_kend'],1,0,'C');
$pdf->Cell(40,5,$var['harga_pertanggungan'],1,0,'C');
$pdf->Cell(27,5,$var['kondisi_pertanggungan'],1,1,'C');
...
$pdf->Cell(40,5,'Premi',1,1,'C');

$pdf->Cell(40,5,$var['harga_pertanggungan'],1,0,'C');
$pdf->Cell(30,5,$var['id_rate'],1,0,'C');
$pdf->Cell(40,5,$premi,1,1,'C');
...
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(14,5,$var['biaya_polis'],0,1,'R');
$pdf->Cell(60,5,'Biaya Materai',0,0,'L');
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(14,5,$var['biaya_materai'],0,1,'R');
