...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM superadmin WHERE no=".$_GET['no'];
...
$no_rek         = $_POST['no_rek'];
 ...
 $sql_query = "UPDATE superadmin SET nip='$nip', nama='$nama', no_hp='$no_hp', username='$username', password='$password', email='$email', nama_bank='$nama_bank', nama_rek='$nama_rek', no_rek='$no_rek' WHERE no=".$_GET['no'];
 // sql query for update data into database
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <li>
                    <a class="active-menu" href="superadmin.php">Super Admin</a>
                    </li>
                    </ul>
                </li> 
                <li>
