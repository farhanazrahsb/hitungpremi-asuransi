...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM okupasi WHERE no=".$_GET['no'];
...
$kode_okupasi     = $_POST['kode_okupasi'];
$keterangan       = $_POST['keterangan'];
 // variables for input data
 
 // sql query for update data into database
 $sql_query = "UPDATE okupasi SET id_okupasi='$id_okupasi', kode_okupasi='$kode_okupasi', keterangan='$keterangan' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='okupasi.php';
  </script>
  <?php
 }
 else
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                    <li>
                    <a class="active-menu" href="okupasi.php">Okupasi</a>
                    </li>
                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <label>ID Okupasi</label>
                                        <input name="id_okupasi" class="form-control" placeholder="ID Okupasi" value="<?php echo $row['id_okupasi']; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        <label>Kode Okupasi</label>
                                        <input type="text" name="kode_okupasi" class="form-control" placeholder="Kode Okupasi" value="<?php echo $row['kode_okupasi']; ?>" />
                                        </div>
                                        <div class="form-group">
                                        <label>Keterangan</label>
                                        <textarea name="keterangan" class="form-control" placeholder="Keterangan" value="<?php echo $row['keterangan']; ?>" ><?php echo $row['keterangan']; ?></textarea>
                                        </div>
