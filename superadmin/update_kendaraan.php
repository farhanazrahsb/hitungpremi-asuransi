...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM rate_kendaraan WHERE no=".$_GET['no'];
...
$rate             = $_POST['rate'];
 ...
 $sql_query = "UPDATE rate_kendaraan SET id_rate='$id_rate', id_kategori='$id_kategori', id_wilayah='$id_wilayah', rate='$rate' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='ratekendaraan.php';
  </script>
  <?php
 }
 else
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <li>
                    <a class="active-menu" href="ratekendaraan.php">Rate All Risk</a>
                    </li>
                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <label>ID Rate</label>
                                        <input name="id_rate" class="form-control" placeholder="ID Rate" value="<?php echo $row['id_rate']; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        <label>Rate</label>
                                        <input name="rate" class="form-control" placeholder="Rate" value="<?php echo $row['rate']; ?>" />
                                        </div>
                                        <div class="form-group">
                                        <label>Kategori</label>
                                        <select name="id_kategori" class="selectpicker form-control" data-live-search="true">
                                        ...
                                        <select name="id_wilayah" class="form-control">
                                            ...
                                            $query=mysql_query("select * from data_wilayah order by id_kategori asc");
                                            
                                            while($row=mysql_fetch_array($query))
                                            {
                                                $kategori=mysql_fetch_array(mysql_query("SELECT kategori FROM kategori WHERE id_kategori='$row[id_kategori]'"));
                                            ?>
                                            <option value="<?php echo $row['id_wilayah']; ?>"><?php echo $row['wilayah']; ?> - <?php echo $kategori['kategori']; ?></option>
                                            <?php 
                                            }
                                            ?>
                                        </select>
