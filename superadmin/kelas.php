                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th colspan="5"><a href="tambah_kelas.php" class="btn btn-danger"> <i class="fa fa-plus"></i> Kelas</a></th>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Kelas</th>
                                    ...
                                    <tr>
                                    <td><?php echo $no ?></td>
                                    <td><?php echo $var ['id_kelas']; ?></td>
                                    <td><?php echo $okupasi ['keterangan']; ?></td>
                                    <td><?php echo $var ['kelas']; ?></td>
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_kelas.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_kelas.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
