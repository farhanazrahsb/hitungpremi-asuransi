...
<html xmlns="http://www.w3.org/1999/xhtml"head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
     <!-- TABLE STYLES--><link href="assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
</head>
<body>
    <div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                include '../koneksi/koneksi.php';
                                // membuat query max
                                  $carikode = mysql_query("select max(id_okupasi) from okupasi") or die (mysql_error());
                                  // menjadikannya array
                                ...
                                echo'
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <input name="id_okupasi" class="form-control" placeholder="ID Okupasi" value="'.$kode_otomatis.'" readonly />
                                        </div>
                                        <div class="form-group">
                                        <label>Kode Okupasi</label>
                                        <input type="text" name="kode_okupasi" class="form-control" placeholder="Kode Okupasi" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO okupasi (id_okupasi, kode_okupasi, keterangan) VALUES ('$_POST[id_okupasi]', '$_POST[kode_okupasi]', '$_POST[keterangan]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_okupasi.php'>";
                                    }else{
