...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM data_wilayah WHERE no=".$_GET['no'];
...
$wilayah          = $_POST['wilayah'];
 ...
 $sql_query = "UPDATE data_wilayah SET id_wilayah='$id_wilayah', id_kategori='$id_kategori', wilayah='$wilayah' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='wilayah.php';
  </script>
  <?php
 }
 else
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <input name="id_wilayah" class="form-control" placeholder="ID Wilayah" value="<?php echo $row['id_wilayah']; ?>" readonly />
                                        </div>
                                        <div class="form-group">
