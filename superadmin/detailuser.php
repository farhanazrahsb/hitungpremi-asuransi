    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                <a href="user.php" class="active-menu"><i class="fa fa-male"></i> User</a>
                </li>
                <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <a class="btn btn-danger" onclick="self.history.back()"> <span class="fa fa-arrow-left" title="Kembali"></span> Back</a> User Detail Tables
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                      ...
                                      $query = mysql_query ("SELECT * FROM datalengkap_user WHERE id_user='$id_user'");
                                      while ($var=mysql_fetch_array($query)) {
                                    ?>
                                    <tr>
                                    <th>ID User</th>
                                    <td><?php echo $var ['id_user']; ?></td>
                                    <td align="center" rowspan="10"><?php echo "<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_detailuser.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <tr>
                                    <th>Nama</th>
                                    ...
                                    <tr>
                                    <th>Jenis Pekerjaan/Usaha</th>
                                    <td><?php echo $var ['jenis_usaha']; ?></td>
                                    </tr>
                                    <tr>
                                    <th>Nama Kantor/Usaha</th>
                                    <td><?php echo $var ['nama_usaha']; ?></td>
                                    </tr>
                                    <tr>
                                    <th>Jenis Usaha Yang Di Jual Belikan</th>
                                    <td><?php echo $var ['usaha_jualbeli']; ?></td>
                                    </tr>
                                    <tr>
                                    <th>Alamat Kantor/Usaha</th>
                                    <td><?php echo $var ['alamat_usaha']; ?></td>
                                    </tr>
                                    <tr>
                                    <th>Foto</th>
