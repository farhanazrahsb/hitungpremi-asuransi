                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        include '../koneksi/koneksi.php';
                                        // membuat query max
                                          $carikode = mysql_query("select max(id_kelas) from rate_kebakaran") or die (mysql_error());
                                          // menjadikannya array
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO rate_kebakaran (id_rate, id_okupasi, id_kelas, rate) VALUES ('$_POST[id_rate]', '$_POST[id_okupasi]', '$_POST[id_kelas]', '$_POST[rate]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_rate_keb.php'>";
                                    }else{
