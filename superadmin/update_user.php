...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM user WHERE no=".$_GET['no'];
...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE user SET id_user='$id_user', nama='$nama', username='$username', password='$password', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <label>ID User</label>
                                        <input name="id_user" class="form-control" placeholder="ID User" value="<?php echo $row['id_user']; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        <label>Nama</label>
