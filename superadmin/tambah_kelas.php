                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        include '../koneksi/koneksi.php';
                                        // membuat query max
                                          $carikode = mysql_query("select max(id_kelas) from kelas_konstruksi") or die (mysql_error());
                                          // menjadikannya array
                                        ...
                                        echo'
                                        <input name="id_kelas" class="form-control" placeholder="ID Kelas" value="'.$kode_otomatis.'" readonly />
                                        ';?>
                                        </div>
                                        <div class="form-group">
                                        <label>Okupasi</label>
                                    ...
                                    if (isset($_POST['save']))
                                    {
                                    $query = mysql_query("INSERT INTO kelas_konstruksi (id_kelas, id_okupasi, kelas) VALUES ('$_POST[id_kelas]', '$_POST[id_okupasi]', '$_POST[kelas]')");

                                    if ($query){
                                    echo "<script>alert('Berhasil Menginput')</script>";
                                    echo "<meta http-equiv='refresh' content='1 url=tambah_kelas.php'>";
                                    }else{
