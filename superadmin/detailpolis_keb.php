                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <td><a href="cetak/cetak_polis_keb.php?&id_order=<?php echo $var['id_order']; ?>" target="blank" type="button" class="btn btn-success btn-md" title="Cetak Polis"><i class="fa fa-print"></i></a></td>
