...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM rate_kendaraan_tlo WHERE no=".$_GET['no'];
...
$rate             = $_POST['rate'];
 ...
 $sql_query = "UPDATE rate_kendaraan_tlo SET id_rate='$id_rate', id_kategori='$id_kategori', id_wilayah='$id_wilayah', rate='$rate' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='ratekendaraan_tlo.php';
  </script>
  <?php
 }
 else
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
                ...
                <li>
                    ...
                    <li>
                    <a class="active-menu" href="ratekendaraan_tlo.php">Rate TLO</a>
                    </li>
                    </ul>
                </li>
                <li>
