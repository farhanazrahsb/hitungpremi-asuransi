                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <td><a href="detailuser.php?&id_user=<?php echo $var['id_user']; ?>" type="button" class="btn btn-danger btn-md" title="Detail User"><?php echo $var ['nama']; ?></a></td>
                                    <td><?php echo $var ['username']; ?></td>
                                    <td><?php echo $var ['email']; ?></td>
                                    <td><?php echo "<a class='fa fa-pencil-square-o fa-lg' title='Edit' href='update_user.php?no=$var[no]'></a> |<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_user.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
