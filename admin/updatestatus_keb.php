...
$status               = $_POST['status'];
 ...
 $sql_query = "UPDATE order_kebakaran SET id_order='$id_order', tanggal='$tanggal', nama='$nama', email='$email', alamat='$alamat', okupasi_bangunan='$okupasi_bangunan', harga_pertanggungan='$harga_pertanggungan', alamat_okupasi='$alamat_okupasi', status='$status' WHERE no=".$_GET['no'];
 // sql query for update data into database
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <input type="text" name="alamat_okupasi" class="form-control" placeholder="Alamat Okupasi" value="<?php echo $row['alamat_okupasi']; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        <label>Status</label>
