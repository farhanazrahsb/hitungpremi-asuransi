                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <td><a href="../superadmin/cetak/cetak_kend.php?&no=<?php echo $var['no']; ?>" target="blank" type="button" class="btn btn-success btn-md" title="Cetak"><i class="fa fa-print"></i></a></td>
