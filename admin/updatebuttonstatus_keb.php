...
$status_button        = $_POST['status_button'];
 // variables for input data
 
 // sql query for update data into database
 $sql_query = "UPDATE order_kebakaran SET id_order='$id_order', status_button='$status_button' WHERE no=".$_GET['no'];
 // sql query for update data into database
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Update Status Button Kendaraan</h2>   
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Isi Data Status Button Kendaraan :
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <select name="status_button" class="form-control">
                                        <option selected="selected">-- Status Button --</option>
