            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        $nama= $_GET['nama'];
                        $query = mysql_query ("SELECT DISTINCT nama FROM polis_keb WHERE nama='$nama'");
                        while ($var=mysql_fetch_array($query)) {
                        ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      ...
                                      $nama= $_GET['nama'];
                                      $query = mysql_query ("SELECT * FROM polis_keb WHERE nama='$nama'");
                                      $no=1;
                                      while ($var=mysql_fetch_array($query)) {
                                    ...
                                    <td><a href="../superadmin/cetak/cetak_polis_keb.php?&id_order=<?php echo $var['id_order']; ?>" target="blank" type="button" class="btn btn-success btn-md" title="Cetak Polis"><i class="fa fa-print"></i></a></td>
                                    ...
                                    <td align="center"><?php echo "<a class='fa fa-trash-o fa-lg' title='Hapus' href='delete_polis_keb.php?no=$var[no]'></a>"; ?></td>
                                    </tr>
                                    <?php
                                    $no++;
                                    }
