...
<section class="contact" id="contact">
	<div class="container">
		<div class="contact-heading">
			<h3 class="heading">Hitung Premi Kendaraan TLO</h3>
		</div>
		<div class="contact-grids">
			...
			<b>1 Unit Kendaraan</b><br><br>
                    <table class="table table-bordered table-hover">
                        <thead>
	                        <tr>
	                        	<th colspan="10"><a class="login" href="#" data-toggle="modal" data-target="#myModal1">Order</a></th>
	                        </tr>
                            <tr>
                                <th>Tahun</th>
                        ...
                        $jenis_kend   = $_GET['jenis_kend'];
                        $plat         = $_GET['plat'];
                        $tahun        = $_GET['tahun'];
                        $harga        = $_GET['harga'];
                        $id_rate      = $_GET['id_rate'];

                        $premi = $harga * $id_rate / 100;
                        $total = $premi + 20000 + 12000;
                        ?>
                            <tr>
                                <td><?php echo "$jangka_waktu"; ?></td>
                                <td><b><?php echo "$jenis_kend"; ?></b></td>
                                <td><b><?php echo "$plat"; ?></b></td>
